...
import caripela_1 from '@/assets/images/caripelas/caripela_1.jpg'
import caripela_2 from '@/assets/images/caripelas/caripela_2.jpg'
import caripela_3 from '@/assets/images/caripelas/caripela_3.jpg'
import Image from 'next/image'

const AboutUs = () => {
  const arr = [
    { img: caripela_2, name: 'Agustin Asaad' },
